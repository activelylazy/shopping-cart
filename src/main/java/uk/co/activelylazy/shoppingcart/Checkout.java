...
public class Checkout {
	...
	private static final Product Apple = new Product("Apple", new BigDecimal("0.60"), 1, 2);
	private static final Product Orange = new Product("Orange", new BigDecimal("0.25"), 2, 3);
